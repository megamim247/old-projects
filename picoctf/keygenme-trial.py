...
def check_key(key, username_trial):
    ...
    #must be same length as key template
    if len(key) != len(key_full_template_trial):
        ...
        # next hashlib.sha256(username_trial).hexdigest()[4]
        if key[i] != hashlib.sha256(username_trial).hexdigest()[4]:
            return False
        else:
            i += 1
        #next hashlib.sha256(username_trial).hexdigest()[5]
        if key[i] != hashlib.sha256(username_trial).hexdigest()[5]:
            return False
        else:
            i += 1
        #next hashlib.sha256(username_trial).hexdigest()[3]
        if key[i] != hashlib.sha256(username_trial).hexdigest()[3]:
            return False
        else:
            i += 1
        #next hashlib.sha256(username_trial).hexdigest()[6]
        if key[i] != hashlib.sha256(username_trial).hexdigest()[6]:
            return False
        else:
            i += 1
        #next hashlib.sha256(username_trial).hexdigest()[2]
        if key[i] != hashlib.sha256(username_trial).hexdigest()[2]:
            return False
        else:
            i += 1
        #next hashlib.sha256(username_trial).hexdigest()[7]
        if key[i] != hashlib.sha256(username_trial).hexdigest()[7]:
            return False
        else:
            i += 1
        #next hashlib.sha256(username_trial).hexdigest()[1]
        if key[i] != hashlib.sha256(username_trial).hexdigest()[1]:
            return False
        else:
            i += 1
        #next hashlib.sha256(username_trial).hexdigest()[8]
